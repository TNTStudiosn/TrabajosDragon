...
/**
 * Maneja los límites de pago diarios para el trabajo de Lenador.
 */
public class LimitePagoDiarioLenador {
    ...
    private static final int LIMITE_LENADOR = 300; // Límite de pago diario para Lenador
    ...
    public static boolean agregarPago(ServerPlayerEntity player, int cantidad) {
        ...
        int nuevoSaldo = Math.min(pagoActual + cantidad, LIMITE_LENADOR);
