...
/**
 * Maneja los límites de pago diarios para el trabajo de Cazador.
 */
public class LimitePagoDiarioCazador {
    ...
    private static final int LIMITE_CAZADOR = 500; // Límite de pago diario para Cazador
    ...
    public static boolean agregarPago(ServerPlayerEntity player, int cantidad) {
        ...
        int nuevoSaldo = Math.min(pagoActual + cantidad, LIMITE_CAZADOR);
